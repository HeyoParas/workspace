...
function createNewTodo() {
    ...
    Task.innerHTML = '<div><input type="checkbox" class="checkbox" onclick="checkmark(this)"></input>' + '<span id='+ timestamp +' >' + todoText + '</span></div>';
    todos.prepend(Task);
...
//             span.removeAttribute("class","completed")
//             status=false;
//         }
...
//             method: 'POST',
//             headers :{"content-Type":"application/json"},
//             body: JSON.stringify({ id: id,isCompleted: status})
//         })
//         .then(response => response.json())
//         .then(data => {
//             console.log('Record deleted:', data);
